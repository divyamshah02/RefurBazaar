# """
# Homepage app — Django Admin registration.

# Place this file at:   Homepage/admin.py

# It registers every model from homepage_models.py with a tailored
# ModelAdmin so staff can manage all homepage content directly from
# /admin/ without needing the custom JS admin panel.
# """

# from django.contrib import admin
# from django.utils.html import format_html

# # Import every model (adjust the import path to match your project layout)
# from .models import (
#     PromoBanner,
#     HeroBannerSlide,
#     TrustStripItem,
